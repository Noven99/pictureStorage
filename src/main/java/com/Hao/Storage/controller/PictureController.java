package com.Hao.Storage.controller;
...
import com.Hao.Storage.annotation.AuthCheck;
import com.Hao.Storage.api.aliyunai.AliYunAiApi;
import com.Hao.Storage.api.aliyunai.model.CreateOutPaintingTaskResponse;
import com.Hao.Storage.api.aliyunai.model.GetOutPaintingTaskResponse;
import com.Hao.Storage.api.imagesearch.ImageSearchApiFacade;
import com.Hao.Storage.api.imagesearch.model.ImageSearchResult;
import com.Hao.Storage.common.BaseResponse;
import com.Hao.Storage.common.DeleteRequest;
import com.Hao.Storage.common.ResultUtils;
...
import com.Hao.Storage.manager.auth.SpaceUserAuthManager;
import com.Hao.Storage.manager.auth.StpKit;
import com.Hao.Storage.manager.auth.annotation.SaSpaceCheckPermission;
import com.Hao.Storage.manager.auth.model.SpaceUserPermissionConstant;
...
import com.Hao.Storage.model.vo.PictureTagCategory;
...
public class PictureController {
    ...
    public BaseResponse<List<ImageSearchResult>> searchPictureByPicture(@RequestBody SearchPictureByPictureRequest searchPictureByPictureRequest) {
        ...
        if (!url.toLowerCase().endsWith(".jpg") && !url.toLowerCase().endsWith(".png")) {
            url += "?imageMogr2/format/png"; // 非标准格式才转换
        }
